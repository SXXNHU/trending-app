...
export const trendTopicSeeds: TrendTopicSeed[] = [
  ...
  },
  {
    id: 'ai-tech',
    label: 'AI기술',
    keywords: ['ChatGPT 사용법', 'Gemini', '이미지 생성 AI', 'AI 코딩'],
    category: 'Tech',
    summary: '생성형 AI 사용법과 생산성 활용법이 계속 확장되면서 검색 수요가 폭넓게 붙고 있어요.',
    issueReason: [
    ...
    orbit: 1,
    angle: 1.55,
    links: ['smartphone-it', 'influencer-youtube'],
    relatedTopics: ['샘 올 트먼', '샘 올트먼', '양자 컴퓨터', '프로젝트 y', '루닛', 'ogfc', 'OGFC', 'ogfc 수원 삼성', '달 탐사', 'fotmob'],
  },
  {
    id: 'smartphone-it',
    label: '스마트폰IT',
    keywords: ['아이폰 신제품', '갤럭시 업데이트', '폰 배터리 절약', '앱 추천'],
    category: 'Tech',
    summary: '신제품 출시와 OS 업데이트, 실사용 팁 수요가 겹쳐 꾸준히 강한 생활형 IT 주제예요.',
    issueReason: [
    ...
    orbit: 2,
    angle: 2.1,
    links: ['ai-tech', 'security'],
    relatedTopics: ['내일 날씨', 'weather tomorrow', 'погода завтра', 'thời tiết ngày mai', 'cuaca besok', '기상', '기온'],
  },
  {
    id: 'security',
    label: '보안해킹',
    ...
    orbit: 0,
    angle: 2.78,
    links: ['politics', 'smartphone-it'],
    relatedTopics: ['법원', '구속', '서울남부구치소', '퇴거', '긴급자동차', '프리깃', '탄도 미사일', '대만 해협'],
  },
  {
    id: 'k-drama',
    label: 'K-드라마예능',
    keywords: ['환승연애4', '폭싹 속았수다', '신작 드라마', '화제 예능'],
    category: 'Content',
    summary: '화제작 공개 직후 리뷰, 결말, 출연진 검색이 몰리는 대표 콘텐츠 축이에요.',
    issueReason: [
    ...
    orbit: 0,
    angle: 3.32,
    links: ['movie', 'k-pop', 'influencer-youtube'],
    relatedTopics: ['나는 solo, 그 후 사랑은 계속된다', '1박 2일', '한국기행', 'MBC', 'mbc', '전현무', '박명수', '김구라', '한가인', '한국경제tv'],
  },
  {
    id: 'movie',
    label: '영화',
    keywords: ['미키17', '한국 영화 순위', '넷플릭스 영화 추천', '개봉 예정작'],
    category: 'Content',
    summary: '극장 흥행과 OTT 추천 수요가 동시에 움직여 파생 검색이 긴 편인 콘텐츠 주제예요.',
    issueReason: [
    ...
    orbit: 1,
    angle: 3.95,
    links: ['k-drama', 'meme-challenge'],
    relatedTopics: ['영화 산업', '극장', '쿠팡플레이', '단테스피크', '변영주', '톱스타뉴스', '레슬매니아 42'],
  },
  {
    id: 'k-pop',
    label: 'K-팝',
  ...
  },
  {
    ...
    orbit: 1,
    angle: 5.66,
    links: ['meme-challenge', 'ai-tech', 'k-drama'],
...
const fallbackTrafficMap: Record<string, { trafficScore: number; buzz: number }> = {
  ...
  'ai-tech': { trafficScore: 93, buzz: 16980 },
  'k-drama': { trafficScore: 90, buzz: 16120 },
  movie: { trafficScore: 87, buzz: 15360 },
  'smartphone-it': { trafficScore: 85, buzz: 14880 },
